 ...
 * @author leo
 */
public class Accettalibro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (bool.equals("accetta")) {
            ...
            Intermedio.updateRecord("capitolo", data, "id=" + idcapitolo);
        } else {
            Intermedio.deleteRecord("capitolo", "id=" + idcapitolo);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Accettalibro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
